...
**v1.15.0** · [Open the tool](https://collapseindex.github.io/jev-builder/) · Apache-2.0
...
- **Say what you expect**: pick the answer this question should give for the text in front of you,
  and every run is marked PASS or FAIL, with a tally of how many matched. It is a note to yourself;
  nothing about it is sent to Jev.
